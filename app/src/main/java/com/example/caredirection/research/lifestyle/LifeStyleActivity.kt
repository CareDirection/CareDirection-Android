...
class LifeStyleActivity : AppCompatActivity() {
    ...
    private fun configureLifeStyleTab(){
        ...
        tl_life_style.getTabAt(0)!!.customView = navIndicatorMainLayout.findViewById(R.id.img_dot_alcohol) as ImageView
        tl_life_style.getTabAt(1)!!.customView = navIndicatorMainLayout.findViewById(R.id.img_dot_vegetable) as ImageView
        tl_life_style.getTabAt(2)!!.customView = navIndicatorMainLayout.findViewById(R.id.img_dot_activity) as ImageView
